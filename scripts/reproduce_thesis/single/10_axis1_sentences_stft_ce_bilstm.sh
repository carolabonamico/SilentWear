...
#
# 10 axis1 sentences stft ce bilstm
# =================================
#
...
start_log "10_axis1_sentences_stft_ce_bilstm"

SUBJECTS_RUN="$SUBJECTS"

train_and_analyse config_thesis/thesis_base_sentences_w2000_rest.yaml \
                  config_thesis/models_configs/sentences_stft_ce_bilstm.yaml \
                  "$DATA_SENTENCES" "$ARTIFACTS_BASE/10_axis1_input_domain/sentences_stft_ce_bilstm" \
                  speechnet 2.0 w2000ms

done_msg "10_axis1_sentences_stft_ce_bilstm" "$ARTIFACTS_BASE/10_axis1_input_domain/sentences_stft_ce_bilstm" "Tables 4.4 and 4.5"
