...
start_log "10_axis1_words_time_ce_none"

SUBJECTS_RUN="$SUBJECTS"

train_and_analyse config_thesis/thesis_base_words_w1400_rest.yaml \
                  config_thesis/models_configs/words_time_ce_none.yaml \
                  "$DATA_WORDS" "$ARTIFACTS_BASE/10_axis1_input_domain/words_time_ce_none" \
                  speechnet 1.4 w1400ms

done_msg "10_axis1_words_time_ce_none" "$ARTIFACTS_BASE/10_axis1_input_domain/words_time_ce_none" "Tables 4.4 and 4.5"
