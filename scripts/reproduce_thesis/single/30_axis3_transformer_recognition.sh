...
#
# 30 axis3 transformer recognition
# ================================
#
...
start_log "30_axis3_transformer_recognition"
...
train_and_analyse config_thesis/thesis_base_sentences_w2000_rest.yaml \
                  ...
                  "$DATA_SENTENCES" "$ARTIFACTS_BASE/30_axis3_sequence_stage/transformer_recognition" \
                  speechnet_transformer 2.0 w2000ms

done_msg "30_axis3_transformer_recognition" "$ARTIFACTS_BASE/30_axis3_sequence_stage/transformer_recognition" "Tables 4.6 and 6.1"
