...
#
# 40 axis4 bilstm classification sweep
# ==============================
#
...
start_log "40_axis4_bilstm_classification_sweep"

SUBJECTS_RUN="$SUBJECTS"
BASE=config_thesis/thesis_base_sentences_w2000_rest.yaml
MODEL=config_thesis/models_configs/sentences_stft_ctc_bilstm_classification_sweep.yaml
ROOT="$ARTIFACTS_BASE/40_axis4_decoder_sweep/bilstm_classification"
