...
#
# 40 axis4 transformer recognition sweep
# ==============================
#
...
MODEL=config_thesis/models_configs/sentences_stft_ctc_transformer_recognition_sweep.yaml
ROOT="$ARTIFACTS_BASE/40_axis4_decoder_sweep/transformer_recognition"
...
done_msg "40_axis4_transformer_recognition_sweep" "$ROOT" "Tables 4.7 and 6.2"
