...
#
# 50 axis5 cue w2000ms recognition
# ================================
#
...
start_log "50_axis5_cue_w2000ms_recognition"
...
train_and_analyse config_thesis/thesis_base_sentences_w2000_norest.yaml \
                  ...
                  "$DATA_SENTENCES" "$ARTIFACTS_BASE/50_axis5_trigger_free/cue_w2000ms_recognition" \
                  speechnet_transformer 2.0 w2000ms

done_msg "50_axis5_cue_w2000ms_recognition" "$ARTIFACTS_BASE/50_axis5_trigger_free/cue_w2000ms_recognition" "Tables 4.10 and 6.4"
