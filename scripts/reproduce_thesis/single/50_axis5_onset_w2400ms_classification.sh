...
#
# 50 axis5 onset w2400ms classification
# =====================================
#
...
start_log "50_axis5_onset_w2400ms_classification"
...
train_and_analyse config_thesis/thesis_base_sentences_onset_w2400_norest.yaml \
                  ...
                  "$DATA_SENTENCES" "$ARTIFACTS_BASE/50_axis5_trigger_free/onset_w2400ms_classification" \
                  speechnet_transformer 2.4 w2400ms

done_msg "50_axis5_onset_w2400ms_classification" "$ARTIFACTS_BASE/50_axis5_trigger_free/onset_w2400ms_classification" "Tables 4.10 and 6.4"
